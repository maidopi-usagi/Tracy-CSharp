...
// <auto-generated>
//  This code was generated by the following tool on 2024-11-05 23:38:00 GMT+08:00:
...
public static unsafe partial class PInvoke
{
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ulong TracyAllocSrcloc(uint line, CString source, int sourceSz, CString function, int functionSz, uint color);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_alloc_srcloc_name")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial ulong TracyAllocSrclocName(uint line, CString source, int sourceSz, CString function, int functionSz, CString name, int nameSz, uint color);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyCustomNameLockableCtx(TracyLockableContextData* lockdata, CString name, int nameSz);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMemoryAlloc(void* ptr, int size, int secure);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_emit_memory_alloc_callstack")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMemoryAllocCallstack(void* ptr, int size, int depth, int secure);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_emit_memory_alloc_callstack_named")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMemoryAllocCallstackNamed(void* ptr, int size, int depth, int secure, CString name);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_emit_memory_alloc_named")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMemoryAllocNamed(void* ptr, int size, int secure, CString name);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMessage(CString txt, int size, int callstack);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_emit_message_appinfo")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMessageAppinfo(CString txt, int size);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_emit_messageC")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitMessageC(CString txt, int size, uint color, int callstack);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitZoneName(TracyCZoneCtx ctx, CString txt, int size);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_emit_zone_text")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyEmitZoneText(TracyCZoneCtx ctx, CString txt, int size);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyFiberEnter(CString fiber);

    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "___tracy_fiber_leave")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void TracyFiberLeave();
